    ...
    return (
        <div className="bgTurbines mb-0 page-section">
            <div className="container">
                ...
                <ParaGraph text={`Wind farms consist of many individual wind turbines, which are connected to the electric power
                ...
                <ParaGraph text={`Wind is an intermittent energy source, which cannot make electricity nor be dispatched on demand.
                ...
                <ParaGraph text={`In 2018, global wind power capacity grew 9.6% to 591 GW. In 2017, yearly wind energy production
