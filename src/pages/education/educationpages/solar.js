    ...
    return (
        <div className="p-padding p-background_image mb-0">
            <div className="container">
                ...
                <PageIntro cardphoto={EducationPages[0].cardphoto} text={EducationPages[0].description}/>

                <ParaGraphtext text={`Solar power is the conversion of energy from sunlight into electricity,
                ...
                <ParaGraphtext text={`Photovoltaics were initially solely used as a source of electricity for small and medium-sized
                ...
                <ParaGraphtext text={`As the cost of solar electricity has fallen, the number of grid-connected solar PV systems has
                ...
                <ParaGraphtext text={`The International Energy Agency projected in 2014 that under its "high renewables" scenario, by 2050,
