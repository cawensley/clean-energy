                ...
                <div className="row d-flex">
                    <div className="col-6 mb-5 text-center">
                     ...
                     <div className="col-6 mb-5 text-left pl-3 pr-5">
                        <p className="lead text-white text-uppercase font-weight-bold">Ken Wilson – Engineer and Scientist</p>
                 ...
                 <div className="row d-flex">
                    ...
                    <div className="col-6 mb-5 text-left pl-3 pr-5">
                        <p className="lead text-white text-uppercase font-weight-bold">Alex Wensley – Webmaster and Engineer</p>
